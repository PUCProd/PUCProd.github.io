...
<div><!--Inicializa a tabela dos horários -->     
    ...
    <table class="table table-bordered 
           ...
           periodo="4">
        <div>
            <h3 style = "text-align: center">Quato Período</h3>
        </div>      
        <tr id = "row0\4">
            <th>
        <h5>Horario</h5>
        ...
        <tr id = "row1\4">
            ...
            <!-- Final do TD -->
            <td rowspan="6">
                <div id="scrollingDiv4" ondrop="drop(event)" ondragover="allowDrop(event)"
                     class = "jumbotron" style="" value="scrollingDiv">
                         ...
                         while ($resultado_disc = mysql_fetch_array($disciplina)) {
                             if (strcmp($resultado_disc['periodo'], "4") == 0) {
                                 $prof = "sem_prof";
