...
<div><!--Inicializa a tabela dos horários -->     
    ...
    <table class="table table-bordered 
           ...
           periodo="5">
        <div>
            <h3 style = "text-align: center">Quinto Período</h3>
        </div>      
        <tr id = "row0\5">
            <th>
        <h5>Horario</h5>
        ...
        <tr id = "row1\5">
            ...
            <!-- Final do TD -->
            <td rowspan="6">
                <div id="scrollingDiv5" ondrop="drop(event)" ondragover="allowDrop(event)"
                     class = "jumbotron" style="" value="scrollingDiv">
                         ...
                         while ($resultado_disc = mysql_fetch_array($disciplina)) {
                             if (strcmp($resultado_disc['periodo'], "5") == 0) {
                                 $prof = "sem_prof";
