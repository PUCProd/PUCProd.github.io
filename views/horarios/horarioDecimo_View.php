...
<div><!--Inicializa a tabela dos horários -->     
    ...
    <table class="table table-bordered 
           ...
           periodo="10">
        <div>
            <h3 style = "text-align: center">Decimo Período</h3>
        </div>      
        <tr id = "row0\10">
            <th>
        <h5>Horario</h5>
        ...
        <tr id = "row1\10">
            ...
            <!-- Final do TD -->
            <td rowspan="6">
                <div id="scrollingDiv10" ondrop="drop(event)" ondragover="allowDrop(event)"
                     class = "jumbotron" style="" value="scrollingDiv">
                         ...
                         while ($resultado_disc = mysql_fetch_array($disciplina)) {
                             if (strcmp($resultado_disc['periodo'], "10") == 0) {
                                 $prof = "sem_prof";
                                 ...
                                 $table = Horarios::getListaNome(10);
                                 $conta = 0;
