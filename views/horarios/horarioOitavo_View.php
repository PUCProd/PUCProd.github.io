...
<div><!--Inicializa a tabela dos horários -->     
    ...
    <table class="table table-bordered 
           ...
           periodo="8">
        <div>
            <h3 style = "text-align: center">Oitavo Período</h3>
        </div>      
        <tr id = "row0\8">
            <th>
        <h5>Horario</h5>
        ...
        <tr id = "row1\8">
            ...
            <!-- Final do TD -->
            <td rowspan="6">
                <div id="scrollingDiv8" ondrop="drop(event)" ondragover="allowDrop(event)"
                     class = "jumbotron" style="" value="scrollingDiv">
                         ...
                         while ($resultado_disc = mysql_fetch_array($disciplina)) {
                             if (strcmp($resultado_disc['periodo'], "8") == 0) {
                                 $prof = "sem_prof";
