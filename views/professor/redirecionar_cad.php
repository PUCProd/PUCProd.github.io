...
<html lang="en">
  <head>
    ...
    <meta http-equiv="refresh" content="1;URL='http://localhost/MVC/professor/getPreferenciaNome'<?php echo $pegaUltimoID?>">   <!-- Cria um redirecionamento para a página relacao     -->
        ...
        <div class="container-fluid">
          ...
          <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li><a href="http://localhost/MVC/professor/pageView ">Professores</a></li>
                <li><a href="http://localhost/MVC/disciplina/pageView">Disciplinas</a></li>
                <li><a href="http://localhost/MVC/relacao/pageView">Relação Prof/Disc</a></li>
